 ...
 * Current Date and Time (UTC - YYYY-MM-DD HH:MM:SS formatted): 2025-02-14 08:55:05
...
class PdfConverter {
     ...
     * @param string|null $outputFilename Optional output filename (without extension)
     * @return array Status and output information
     */
    public function convertPdfToImage($pdfPath, $outputDir, $pageNumber = 0, $scale = 1.0, $outputFilename = null) {
        try {
            ...
            if ($outputFilename === null) {
                ...
                $outputFilename = $outputFilename . '.png'; // Ensure .png extension
            }
