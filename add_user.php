<?php
// add_user.php
// Current Date and Time (UK - DD-MM-YYYY HH:MM:SS formatted): 25-01-2025 13:03:04
...
<head>
    ...
    <meta name="last-modified" content="2025-01-25 13:04:01">
                ...
                <form id="addUserForm" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="user_type" name="user_type" required>
                            ...
                            <option value="inspector">Inspector - Inspection and reporting access</option>
